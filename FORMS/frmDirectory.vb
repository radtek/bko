    ...
    Private Sub DELETE_SPR(Optional ByVal ssid As Integer = 0)
        ...
        Select Case tvDirectory.SelectedNode.Text
            ...
            Case objIniFile.GetString("frmDirectory", "MSG57", "Пользователь")
                ...
                '#######################################
                rs = New Recordset
                rs.Open("Delete FROM SPR_USER WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG27", "Оптические накопители")
                rs = New Recordset
                rs.Open("Delete FROM SPR_OPTICAL WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG3", "USB Устройства")
                ...
                rs = New Recordset
                rs.Open("Delete FROM SPR_USB WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG4", "ZIP")
                rs = New Recordset
                rs.Open("Delete FROM spr_zip WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG5", "Акустические системы")
                ...
                rs = New Recordset
                rs.Open("Delete FROM SPR_ASISTEM WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG6", "Источники БП")
                ...
                rs = New Recordset
                rs.Open("Delete FROM SPR_IBP WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG7", "Клавиатуры")
                rs = New Recordset
                rs.Open("Delete FROM SPR_KEYBOARD WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG8", "Копиры")
                rs = New Recordset
                rs.Open("Delete FROM SPR_KOPIR WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG34", "Модемы")
                rs = New Recordset
                rs.Open("Delete FROM SPR_MODEM WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG9", "Мониторы")
                rs = New Recordset
                rs.Open("Delete FROM SPR_MONITOR WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG10", "МФУ")
                ...
                rs = New Recordset
                rs.Open("Delete FROM SPR_MFU WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG11", "Мыши")
                rs = New Recordset
                rs.Open("Delete FROM SPR_MOUSE WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG12", "Принтеры")
                rs = New Recordset
                rs.Open("Delete FROM SPR_PRINTER WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG13", "Сетевые фильтры")
                rs = New Recordset
                rs.Open("Delete FROM SPR_FS WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG14", "Сетевые устройства")
                rs = New Recordset
                rs.Open("Delete FROM SPR_DEV_NET WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG15", "Сканер")
                rs = New Recordset
                rs.Open("Delete FROM SPR_SCANER WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG16", "Телефон")
                rs = New Recordset
                rs.Open("Delete FROM spr_phone WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG17", "Факс")
                rs = New Recordset
                rs.Open("Delete FROM spr_fax WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG18", "Фотоаппарат")
                rs = New Recordset
                rs.Open("Delete FROM spr_photo WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG20", "Видео карты")
                rs = New Recordset
                rs.Open("Delete FROM SPR_SVGA WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG21", "Дисководы")
                rs = New Recordset
                rs.Open("Delete FROM SPR_FDD WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG22", "Жесткие диски")
                rs = New Recordset
                rs.Open("Delete FROM SPR_HDD WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG23", "Звуковые карты")
                rs = New Recordset
                rs.Open("Delete FROM SPR_SOUND WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG26", "Модули памяти")
                rs = New Recordset
                rs.Open("Delete FROM SPR_RAM WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG29", "Сетевые карты")
                rs = New Recordset
                rs.Open("Delete FROM SPR_NET WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG43", "Уровень заявки")
                rs = New Recordset
                rs.Open("Delete FROM SPR_Uroven WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG45", "Тип заявки")
                rs = New Recordset
                rs.Open("Delete FROM spr_tip_z WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG49", "Тип компьютера")
                rs = New Recordset
                rs.Open("Delete FROM SPR_TIP WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG51", "Оборудование (Другое-тип)")
                rs = New Recordset
                rs.Open("Delete FROM spr_other WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG52", "Оборудование (Другое-устройства)")
                rs = New Recordset
                rs.Open("Delete FROM SPR_OTH_DEV WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG53", "Тип лицензии")
                rs = New Recordset
                rs.Open("Delete FROM SPR_LIC WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
            ...
            Case objIniFile.GetString("frmDirectory", "MSG56", "Программное обеспечение")
                rs = New Recordset
                rs.Open("Delete FROM SPR_PO WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG33", "Корпус")
                rs = New Recordset
                rs.Open("Delete FROM SPR_CASE WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG24", "Кардридер")
                rs = New Recordset
                rs.Open("Delete FROM SPR_CREADER WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing

            Case objIniFile.GetString("frmDirectory", "MSG31", "Блок питания")
                rs = New Recordset
                rs.Open("Delete FROM SPR_BP WHERE id =" & dSID, DB7, CursorTypeEnum.adOpenDynamic,
                        LockTypeEnum.adLockOptimistic)
                rs = Nothing
        ...
        Select Case tvDirectory.SelectedNode.Text
            ...
            Case objIniFile.GetString("frmDirectory", "MSG36", "Мастер")
                ...
                If sNUM > 0 Then
                    rscount = New Recordset
                    rscount = New Recordset
                    rscount.Open("UPDATE Remont SET master='" & sNAME & "' WHERE master='" & sREALNAME & "'", DB7,
                                 CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic)
                    rscount = Nothing
                End If
                ...
                If sNUM > 0 Then
                    rscount = New Recordset
                    rscount = New Recordset
                    rscount.Open("UPDATE Zametki SET master='" & sNAME & "' WHERE master='" & sREALNAME & "'", DB7,
                                 CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic)
                    rscount = Nothing
                End If
                ...
                If sNUM > 0 Then
                    rscount = New Recordset
                    rscount = New Recordset
                    rscount.Open("UPDATE ZAM_OTD SET master='" & sNAME & "' WHERE master='" & sREALNAME & "'", DB7,
                                 CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic)
                    rscount = Nothing
                End If
                ...
                If sNUM > 0 Then
                    rscount = New Recordset
                    rscount = New Recordset
                    rscount.Open("UPDATE remonty_plus SET master='" & sNAME & "' WHERE master='" & sREALNAME & "'", DB7,
                                 CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic)
                    rscount = Nothing
                End If
            ...
            Case objIniFile.GetString("frmDirectory", "MSG37", "Ответственный")
                ...
                Else
                    ...
                    If sNUM > 0 Then
                        ...
                        rscount = New Recordset
                        rscount.Open(
                            "UPDATE kompy SET OTvetstvennyj='" & sNAME & "' WHERE OTvetstvennyj='" & sREALNAME & "'",
                            DB7, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic)
                        rscount = Nothing
                    End If
