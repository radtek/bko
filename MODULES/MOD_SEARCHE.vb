Module MOD_SEARCHE
    ...
    Public Sub Search(ByVal sFindText As String, ByVal lstGroups As TreeView, ByVal gbTree As GroupBox, ByVal sMOD As String, Optional ByVal MtchWord As Byte = 0, Optional ByVal MtchCase As Byte = 0)
